...
export default function GameCanvas({
  ...
  useEffect(() => {
    ...
    bg.onerror = () => {
      ...
      bgFallback.src = '/src/assets/images/manuk_mbah_background_1779513507940.png';
      bgFallback.onload = () => {
  ...
  const loadDefaultBirdImage = () => {
    ...
    bird.onerror = () => {
      // Fallback path if bird.png is not yet populated
      const birdFallback = new Image();
      birdFallback.src = '/src/assets/images/manuk_mbah_bird_1779513487884.png';
      birdFallback.onload = () => {
        birdImgRef.current = birdFallback;
        processBirdTransparency();
      };
    };
  };
